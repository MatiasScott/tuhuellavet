        ...
        if (campo === 'identificacion') {
            ...
            if (tipo === 'PASAPORTE') {
                return validarPasaporte(valor.toUpperCase())
                    ...
                    : {
                        valido: false,
                        mensaje: 'El pasaporte debe contener dos letras y entre seis y siete números.'
                    };
            }
        ...
        async function validate(field) {
            ...
            try {
                ...
                setMessage(
                    field,
                    'error',
                    'No se pudo verificar. Intenta nuevamente.'
                );
            }
        }
