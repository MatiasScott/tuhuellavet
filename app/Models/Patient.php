...
{
    public function countByEnvironment(
        int $environmentId
    ): int {
    ...
    public function recentByEnvironment(
        int $environmentId,
        int $limit = 5
    ): array {
        $limit = max(
    ...
    public function allByEnvironment(
        int $environmentId,
        string $search = ''
    ): array {
        $sql = '
    ...
    public function findInEnvironment(
        int $patientId,
        int $environmentId
    ): ?array {
        $stmt = $this->db->prepare(
