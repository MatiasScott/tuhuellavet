...
class Catalog extends Model
{
    ...
    {
        return $this->rows('SELECT id,codigo,nombre,simbolo,categoria FROM unidades_medida ORDER BY nombre');
    }
    ...
    {
        return $this->rows('SELECT id,codigo,nombre,precio_base FROM servicios WHERE activo=1 ORDER BY nombre');
    }
