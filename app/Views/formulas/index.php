        ...
        <form method="POST" action="<?= url('/formulas') ?>">
            ...
            <div class="modal-body">
                <div class="form-grid">
                    ...
                    <label>
                        <span>Categoría</span>
                        <select name="categoria_formula_id"><?php foreach ($categories as $x): ?>
                    ...
                    <label>
                        ...
                        <select name="unidad_resultado_id">
                            ...
                            <?php foreach ($units as $x): ?>
                                <option value="<?= $x['id'] ?>"><?= e($x['simbolo'] . ' · ' . $x['nombre']) ?></option>
                            <?php endforeach; ?>
                        </select>
                    </label>
                ...
                <div id="formula-vars" class="stack">
                    <div class="form-grid soft-panel">
                        ...
                        <label>
                            <span>Tipo</span>
                            <select name="variables[0][tipo_variable_id]">
                        ...
                        <label>
                            <span>Origen</span>
                            <select name="variables[0][origen_variable_id]">
                        ...
                        <label>
                            ...
                            <select name="variables[0][unidad_medida_id]">
                                <option value="">—</option>
                                <?php foreach ($units as $x): ?>
                                    <option value="<?= $x['id'] ?>"><?= e($x['simbolo']) ?></option>
                                <?php endforeach; ?>
                            </select>
                        </label>
                        <label>
            ...
            <div class="modal-footer">
                <button class="btn btn-primary">Crear fórmula</button>
            </div>
        </form>
    </div>
</div>
        ...
        <div class="form-grid">
            <label>
                ...
                <input
                    ...
                    placeholder="PESO"
                    pattern="[A-Z_]+"
                    title="El código debe estar en mayúsculas y puede contener guiones bajos.">
            </label>
            <label>
                <span>Etiqueta</span>
                <input
            ...
            <div class="modal-body">
                ...
                <label class="field-full">
                    ...
                    <input
                        ...
                        readonly
                        placeholder="La expresión se generará automáticamente">
                </label>
