...
<div class="page-heading">
    ...
    </div><?php if (can('propietarios.crear')): ?><button class="btn btn-primary" data-modal-open="owner-create">＋ Nuevo propietario</button><?php endif; ?>
    ...
    <form class="toolbar">
        <div class="search-box">🔎<input name="q" value="<?= e($search) ?>" placeholder="Buscar propietario..."></div><button class="btn btn-secondary">Buscar</button>
    </form>
...
<div class="modal" id="owner-create">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-header">
            <h2>Nuevo propietario</h2><button class="modal-close" data-modal-close>×</button>
        </div>
        <form method="POST" action="<?= url('/propietarios') ?>" class="owner-validation-form"
            data-validation-url="<?= url('/propietarios/validar') ?>"><?= csrf_field() ?><div class="modal-body">
                <div class="form-grid">
                    <label>
                        <span>Nombres *</span><input name="nombres" required>
                    </label>
                    <label>
                        <span>Apellidos</span><input name="apellidos">
                    </label>
                    <label>
                    ...
                    <label class="field-full">
                        <span>Dirección</span><input name="direccion">
                    </label>
                    <label class="field-full">
                        <span><input type="checkbox" name="crear_acceso" value="1"> Crear acceso de cliente automáticamente</span>
                    </label>
                </div>
            </div>
            <div class="modal-footer"><button type="button" class="btn btn-secondary" data-modal-close>Cancelar</button><button class="btn btn-primary">Crear</button></div>
        </form>
    </div>
</div>
<script
