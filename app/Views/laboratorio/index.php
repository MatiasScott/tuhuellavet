...
<div class="page-heading">
    ...
    </div><button class="btn btn-primary" data-modal-open="lab-create">＋ Examen</button>
...
<div class="modal" id="lab-create">
    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-header">
            <h2>Nuevo examen</h2><button class="modal-close" data-modal-close>×</button>
        </div>
        <form method="POST" enctype="multipart/form-data" action="<?= url('/laboratorio') ?>"><?= csrf_field() ?><div class="modal-body form-grid">
                <label>
                    <span>Paciente</span>
