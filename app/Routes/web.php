...
$router->get('/',function(){if(!is_authenticated()){header('Location: '.url('/login'));exit;}if(!active_environment_id()){header('Location: '.url('/seleccionar-entorno'));exit;}header('Location: '.url('/dashboard'));exit;});
...
$router->get('/media/pacientes/{filename}',[MediaController::class,'patientPhoto'],['auth']);
...
$router->get('/cirugias',[CirugiaController::class,'index'],['auth','environment','permission:cirugias.ver']);
$router->post('/cirugias',[CirugiaController::class,'store'],['auth','environment','permission:cirugias.crear']);
