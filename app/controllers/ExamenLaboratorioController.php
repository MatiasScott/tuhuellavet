...
final class ExamenLaboratorioController extends Controller
{
    private ExamenLaboratorioService $service;

    public function __construct()
    {
        $this->service = new ExamenLaboratorioService();
    }
